...
data_dir_path = os.path.join(prj_home, "Datas", "ThresholdToneDetection_2AFC")
...
# ===== SET UP STIMULI ===== #
# ========================== #
expParamPath = os.path.join(data_dir_path, 'lastThresholdTone2afcParams.pickle')
...
logPath = os.path.join(data_dir_path, fileName+'.txt')
dataFile = open(logPath, 'w')
