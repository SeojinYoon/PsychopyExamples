...
data_dir_path = os.path.join(prj_home, "Datas", "GetPerceptualThreshold")
...
# ===== SET UP STIMULI ===== #
# ========================== #
expParamPath = os.path.join(data_dir_path, 'lastThresholdParams.pickle')
...
dataFilePath = os.path.join(data_dir_path, fileName) + '.txt'
