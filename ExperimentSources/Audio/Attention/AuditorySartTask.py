...
data_dir_path = os.path.join(prj_home, "Datas", "AuditorySartTask")
...
# ===== SET UP LOGGING ===== #
# ========================== #
expParamPath = os.path.join(data_dir_path, 'lastAudSartParams.pickle')
...
logging.LogFile((os.path.join(data_dir_path, fileName) + '.log'), level=logging.INFO)#, mode='w') # w=overwrite
