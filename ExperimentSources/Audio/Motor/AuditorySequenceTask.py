...
# Data directory
data_dir_path = os.path.join(prj_home, "Datas", "AuditorySeqeuenceTask")
...
# declare other stimulus parameters
    ...
    'visHeight': 1, # 3,           # size of text stimuli,
    'wrapWidth' : 30, # 50,
}
...
expParamPath = os.path.join(data_dir_path, "lastAudSeqInfo.pickle")
...
# make text messages
message1 = visual.TextStim(win, pos=[0, 0], wrapWidth=params["wrapWidth"], color='#000000', alignHoriz='center', name='topMsg', text="aaa", height=params["visHeight"])
message2 = visual.TextStim(win, pos=[0,-10], wrapWidth=params["wrapWidth"], color='#000000', alignHoriz='center', name='bottomMsg', text="bbb", height=params["visHeight"])
